...
export async function generateInvoicePDF(invoiceData) {
  ...
  const terms = [
    ...
    "7. Eeda Damodara Rao is a SEBI registered Research Analyst with registration number INH000024967. We do not offer profit-sharing, PMS-based services, or Demat Account handling services. Our offerings are strictly research-based recommendations available on a prepaid subscription basis.",
